...
public class Sidebar extends JPanel {
	...
	public Sidebar() {
		...
		lb_ql_nhanvien.setBackground(new Color(255, 212, 58));
		lb_ql_nhanvien.setBounds(0, 242, 280, 49);
		add(lb_ql_nhanvien);
		...
		lb_khachhang.setBackground(new Color(255, 212, 58));
		lb_khachhang.setBounds(0, 302, 280, 49);
		add(lb_khachhang);
		...
		lb_ql_monan.setBackground(new Color(255, 212, 58));
		lb_ql_monan.setBounds(0, 362, 280, 49);
		add(lb_ql_monan);
		...
		lb_quanlimaytinh.setBackground(new Color(255, 212, 58));
		lb_quanlimaytinh.setBounds(0, 422, 280, 49);
		...
		lb_doanhthu.setBackground(new Color(255, 212, 58));
		lb_doanhthu.setBounds(0, 482, 280, 49);
		add(lb_doanhthu);
