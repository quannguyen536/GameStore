...
import views.component.So_tang;

public class So_tang extends JPanel{
	private JPanel panel;
	private JLabel lb_nhanVienTruc;
	private JLabel lb_trangThai;
	private int quay;
	private Models_Nhanvien nhanvien;

	public So_tang(int quay) {
		this.quay = quay;
		...
		lb_trangThai.setIcon(new ImageIcon(So_tang.class.getResource("/images/icons/icons8-wi-fi-35.png")));
		...
		lb_nhanVienTruc.setIcon(new ImageIcon(So_tang.class.getResource("/images/icons/icons8-customer-35.png")));
	...
	public void online(Models_Nhanvien nhanvien) {
		this.nhanvien = nhanvien;
		lb_nhanVienTruc.setText(nhanvien.getTennv());
		lb_trangThai.setText("Đang hoạt động");
		lb_trangThai.setForeground(new Color(35, 210, 52));
		lb_trangThai.setIcon(new ImageIcon(So_tang.class.getResource("/images/online.png")));
		lb_nhanVienTruc.setIcon(new ImageIcon(So_tang.class.getResource("/images/staff_online.png")));
	}
	...
	public void offline() {
		...
		lb_trangThai.setForeground(Color.RED);
		lb_trangThai.setIcon(new ImageIcon(So_tang.class.getResource("/images/offline.png")));
		lb_nhanVienTruc.setIcon(new ImageIcon(So_tang.class.getResource("/images/staff_offline.png")));
	}
