...
public class BlankPlotCharts extends JComponent{
	
	
	
	  public BlankPlotChatRenders getBlankPlotChatRender() {
		return blankPlotChatRender;
	}

	public void setBlankPlotChatRender(BlankPlotChatRenders blankPlotChatRender) {
	...
	private final DecimalFormat format = new DecimalFormat("#,##0.##");
	    private NiceScales niceScale;
	    private double maxValues;
	    private double minValues;
	    private int labelCount;
	    private String valuesFormat = "#,##0.##";
	    private BlankPlotChatRenders blankPlotChatRender;

	    public BlankPlotCharts() {
	    ...
	    public void initValues(double minValues, double maxValues) {
	        ...
	        this.maxValues = maxValues;
	        niceScale = new NiceScales(minValues, maxValues);
	        repaint();
	    }
	    ...
	    public SeriesSizes getRectangle(int index, double height, double space, double startX, double startY) {
	        double x = startX + space * index;
	        SeriesSizes size = new SeriesSizes(x, startY+1, space, height);
	        return size;
	    }
