...
public class ClientHandlers extends Thread {
    ...
    public ClientHandlers(int userId, Services service, BufferedReader in, DataOutputStream out, ArrayList<ClientHandlers> clients, Socket socket, SecretKey aesKey) {
        this.userId = userId;
...
//	                }
//	            } catch (Exception e) {
//	                service.getInstance().getMain().getBody().getQuannet().offline(userId);
...
//	}
	...
	public ArrayList<ClientHandlers> getClients() {
		return clients;
	}

	public void setClients(ArrayList<ClientHandlers> clients) {
		this.clients = clients;
	}
